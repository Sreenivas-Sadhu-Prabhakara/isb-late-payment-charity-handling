package com.bank.islamic.latepaymentcharityhandling.model;
...
/**
 * The BIAN control record for this service domain: "Late Payment Charity Entry Procedure".
 *
 ...
 * to its asset type (Late Payment Charity Entry). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Late Payment Charity Entry Procedure";
